...
function validateForm() {
  resetErrors(
    [markaInput, typInput, numerRejestracyjnyInput, rokProdukcjiInput, pojemnoscInput],
    [errorMarka, errorTyp, errorNumerRejestracyjny, errorRokProdukcji, errorPojemnosc],
    errorsSummary
  );
  let valid = true;
