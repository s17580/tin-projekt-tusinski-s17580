...
function validateForm() {
  resetErrors(
    [ulicaInput, numer_lokaluInput, kod_pocztowyInput, miastolInput],
    [errorUlica, errorNumer_Lokalu, errorKod_Pocztowy, errorMaiasto],
    errorsSummary
  );
  let valid = true;
  ...
  } else if (!checkKodPocztowy(kod_pocztowyInput.value)) {
    valid = false;
    kod_pocztowyInput.classList.add("error-input");
    errorKod_Pocztowy.innerText = "Kod pocztowy jest niepoprawny";
  }
